...
from Asgard.Bragi.Architecture.utilities.ast_utils import extract_classes
from Asgard.Bragi.Quality.utilities.file_utils import scan_directory
from Asgard.Bragi.Architecture.services._pattern_reporter import (
    generate_text_report as _gen_text,
    generate_json_report as _gen_json,
    generate_markdown_report as _gen_markdown,
)
from Asgard.Bragi.Architecture.services._pattern_detectors import (
    detect_singleton,
    detect_factory,
    detect_builder,
    detect_adapter,
