...
from Asgard.Bragi.Architecture.services._suggester_reporter import (
    generate_text_report as _gen_text,
    generate_json_report as _gen_json,
    generate_markdown_report as _gen_markdown,
)
from Asgard.Bragi.Architecture.services._suggester_helpers import (
    analyse_class as _analyse_class_fn,
)
from Asgard.Bragi.Architecture.services._suggester_ast_helpers import (
