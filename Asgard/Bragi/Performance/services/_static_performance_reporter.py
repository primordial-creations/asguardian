...
from Asgard.Bragi.Performance.models.performance_models import PerformanceReport
...
def generate_summary(report: PerformanceReport) -> str:
    ...
    lines = [
        ...
        "SUMMARY",
        "-" * 40,
        f"Performance Score: {report.performance_score:.1f}/100" if report.is_complete else "Performance Score: unavailable (INCOMPLETE)",
        f"Analysis Complete: {report.is_complete}",
