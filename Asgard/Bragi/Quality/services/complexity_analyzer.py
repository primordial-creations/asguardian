...
from Asgard.Bragi.Quality.services._complexity_visitors import (
    CyclomaticComplexityVisitor,
    CognitiveComplexityVisitor,
)
from Asgard.Bragi.Quality.services._complexity_report import (
...
class ComplexityAnalyzer:
    ...
    def _analyze_generic_file(self, file_path: Path, analysis: FileComplexityAnalysis) -> FileComplexityAnalysis:
        ...
        from Asgard.Bragi.Quality.services._generic_complexity import analyse_file as generic_analyse
