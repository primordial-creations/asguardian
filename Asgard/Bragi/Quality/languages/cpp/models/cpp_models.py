...
class CppRuleCategory(str, Enum):
    SECURITY = "security"
    QUALITY = "quality"
    STYLE = "style"
...
class CppSeverity(str, Enum):
    ERROR = "error"
    WARNING = "warning"
    INFO = "info"


class CppFinding(BaseModel):
    file_path: str
    line_number: int
    column: int = 0
    rule_id: str
    category: CppRuleCategory
