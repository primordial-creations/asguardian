"""
Heimdall Modularity Analyzer - Helper Functions

Standalone helper functions for graph operations, community detection,
boundary violation detection, coupling reporting, and layering analysis.
"""
...
from Asgard.Heimdall.Dependencies.models.dependency_models import ModuleDependencies
...
def detect_communities_nx(
    ...
    try:
        ...
        # Fallback
        return detect_communities_simple(graph), 0.0
...
def detect_communities_simple(
    ...
    undirected: Dict[str, Set[str]] = {module: set() for module in graph}
...
def get_boundary_violations(
    ...
    Args:
        modules: List of analyzed module dependencies
...
def get_coupling_report(
    ...
    Args:
        modules: List of analyzed module dependencies
        reverse: Reverse dependency graph

    Returns:
        List of module coupling information sorted by instability
    """
    report = []
    for module in modules:
