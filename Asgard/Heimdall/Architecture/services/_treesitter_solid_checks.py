...
def _fallback_srp(file_path: str, source: str, language: str, rules: Dict[str, bool]) -> List[Dict]:
    from Asgard.Heimdall.Architecture.services._generic_solid_checks import check_srp_method_count
...
def _fallback_isp(file_path: str, source: str, language: str, rules: Dict[str, bool]) -> List[Dict]:
    from Asgard.Heimdall.Architecture.services._generic_solid_checks import check_isp_interface_size
    lines = source.splitlines()
...
def _fallback_dip(file_path: str, source: str, language: str, rules: Dict[str, bool]) -> List[Dict]:
    from Asgard.Heimdall.Architecture.services._generic_solid_checks import check_dip_concrete_instantiation
    lines = source.splitlines()
...
def _fallback_ocp(file_path: str, source: str, language: str, rules: Dict[str, bool]) -> List[Dict]:
    from Asgard.Heimdall.Architecture.services._generic_solid_checks import check_ocp_type_checking
    lines = source.splitlines()
