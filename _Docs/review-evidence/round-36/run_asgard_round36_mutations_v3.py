...
mutations = [
    ...
    ("ROI map keys widened to Any", 'roi_by_type: Dict[str, float] = Field(default_factory=dict, description="ROI by debt type")', 'roi_by_type: Dict[Any, float] = Field(default_factory=dict, description="ROI by debt type")'),
]
